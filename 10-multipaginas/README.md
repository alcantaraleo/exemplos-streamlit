...
Este exemplo ensina a criar um **app com várias páginas** no Streamlit. O Streamlit usa a **estrutura de pastas** para isso: cada arquivo `.py` dentro da pasta `pages/` vira uma página no menu lateral.
