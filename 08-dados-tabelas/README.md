...
Este exemplo ensina a exibir **tabelas de dados** no Streamlit: **st.dataframe** (tabela interativa, que pode ordenar e rolar) e **st.table** (tabela estática). Usamos a biblioteca **pandas** para criar os dados.
