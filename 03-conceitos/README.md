...
Este exemplo ensina **conceitos importantes** do Streamlit: como organizar a tela com **sidebar** e **colunas**, e um pouco sobre o **modelo de execução** (o script roda de cima para baixo e pode rodar de novo quando o usuário interage).
