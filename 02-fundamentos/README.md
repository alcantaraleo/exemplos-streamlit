...
Este exemplo ensina os **conceitos básicos** do Streamlit: como um app é estruturado, como rodar com `streamlit run`, e como exibir texto e dados na tela usando `st.write` e "magic".
